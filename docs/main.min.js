...
var Ares=function(){var a=function(){var a=jQuery("html");jQuery('[data-toggle="appear"]').each(function(){var e=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth,t=jQuery(this),r=t.data("class")?t.data("class"):"animated fadeIn",i=t.data("offset")?t.data("offset"):0,n=a.hasClass("ie9")||e<992?0:t.data("timeout")?t.data("timeout"):0;t.appear(function(){setTimeout(function(){t.removeClass("visibility-hidden").addClass(r)},n)},{accY:i})})},e=function(){jQuery('[data-toggle="countTo"]').each(function(){var a=jQuery(this),e=a.data("after"),t=a.data("before"),r=a.data("speed")?a.data("speed"):1500,i=a.data("interval")?a.data("interval"):15;a.appear(function(){a.countTo({speed:r,refreshInterval:i,onComplete:function(){e?a.html(a.html()+e):t&&a.html(t+a.html())}})})})},t=function(){jQuery(".js-pie-chart").easyPieChart({barColor:jQuery(this).data("bar-color")?jQuery(this).data("bar-color"):"#777777",trackColor:jQuery(this).data("track-color")?jQuery(this).data("track-color"):"#eeeeee",lineWidth:jQuery(this).data("line-width")?jQuery(this).data("line-width"):3,size:jQuery(this).data("size")?jQuery(this).data("size"):"80",animate:jQuery(this).data("animate")?jQuery(this).data("animate"):1e4,scaleColor:!!jQuery(this).data("scale-color")&&jQuery(this).data("scale-color")})};return{initHelper:function(r){switch(r){case"appear":a();break;case"appear-countTo":e();break;case"easy-pie-chart":t();break;default:return!1}},initHelpers:function(a){if(a instanceof Array)for(var e in a)Ares.initHelper(a[e]);else Ares.initHelper(a)}}}();